...
<?php $__env->startSection('judul', 'DJAJAN'); ?>
...
<html lang="en">
  ...
  <body>
      ...
      <div class="card1">
        ...
        <a href="<?php echo e(URL('/makanan1')); ?>"><button>Detail</button></a>
      </div>
      </div>
      <div class="card2">
      <div class="card-body">
        ...
        <a href="<?php echo e(URL('/makanan3')); ?>"><button>Detail</button></a>
      </div>
      </div>
      <div class="card3">
      <div class="card-body">
        ...
        <a href="<?php echo e(URL('/main1')); ?>"><button>Detail</button></a>
      </div>
      </div>
      <div class="card4">
      <div class="card-body">
        ...
        <a href="<?php echo e(URL('/main2')); ?>"><button>Detail</button></a>
      </div>
      </div>
      <div class="card5">
      <div class="card-body">
        ...
        <a href="<?php echo e(URL('/main3')); ?>"><button>Detail</button></a>
      </div>
      </div>
      <div class="card6">
      <div class="card-body">
        ...
        <a href="<?php echo e(URL('/dessert3')); ?>"><button>Detail</button></a>
      </div>
      </div>
      <div class="card7">
      <div class="card-body">
        ...
        <a href="<?php echo e(URL('/dessert1')); ?>"><button>Detail</button></a>
      </div>
      </div>
      <div class="card8">
      <div class="card-body">
      ...
      <div class="card-body">
        ...
        <a href="<?php echo e(URL('/minum1')); ?>"><button>Detail</button></a>
      </div>
      </div>
      <div class="card10">
      <div class="card-body">
        ...
        <a href="<?php echo e(URL('/makanan2')); ?>"><button>Detail</button></a>
      </div>
      </div>
    </div>
    </div>
...
<?php echo $__env->make('Base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\app\test2-laravel\resources\views/home.blade.php ENDPATH**/ ?>